...
(function() {
    ...
    function initHeader() {
        ...
        console.log("What is width? ", height)
        ...
        // create points
        points = [];
        for (var x = 0; x < width; x = x + width / division) {
            for (var y = 0; y < height; y = y + height / division) {
                var px = x + Math.random() * width / division;
                var py = y + Math.random() * height / division;
                var p = {
                    x: px,
                    originX: px,
                    y: py,
